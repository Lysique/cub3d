...
#    Updated: 2022/01/20 12:35:57 by tamighi          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSER_FILES = parser.c parser_free.c parser_error.c fd_to_arr.c parse_textures.c parser_utils.c add_texture_to_struct.c parse_map.c map_checker.c char_or_player.c

...
#    Updated: 2022/01/22 16:34:33 by tamighi          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSER_FILES = parser.c parser_free.c parser_error.c fd_to_arr.c parse_map.c parse_textures.c player_init.c parser_utils.c parser_utils2.c
